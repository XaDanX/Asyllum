...
enum HKey {
    ...
    F3, F4, F5, F6, F7, F8, F9, F10, NUM, SCROLL, HOME, UP, PAGE_UP, NUM_MINUS, LEFT, CENTER, RIGHT, PLUS, END, DOWN, PAGE_DOWN, INSERT, DEL, MOUSE_LEFT_BTN, MOUSE_RIGHT_BTN, MOUSE_SIDE_BTN, MOUSE_SIDE_BTN2
};
...
static const char* KeyNames[] = {
        ...
        "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "Num", "Scrl", "Home", "Num8", "PgUp", "NumMinus", "Num4", "Num5", "Num6", "NumPlus", "End", "NumDown", "PgDown", "Insert", "Del", "MouseLeftBtn", "MouseRightBtn", "MouseSideBtn", "MouseSideBtn2"
};
