...
#ifndef ASYLLUM_XORSTR_H
#define ASYLLUM_XORSTR_H
...
inline auto
operator==(const _Basic_XorStr<_string_type, _length> &lhs, const _Basic_XorStr<_string_type, _length2> &rhs) {
