...
std::vector<Vector3> AiManager::GetNavigationArray() {
    ...
    int navigationArraySize = *reinterpret_cast<int*>(reinterpret_cast<DWORD>(this) +
                                                      Offsets::AiManager::NavigationArray + 0x4);
    if (navigationArraySize > 1) {
        int navigationArray = *reinterpret_cast<int*>(reinterpret_cast<DWORD>(this) +
